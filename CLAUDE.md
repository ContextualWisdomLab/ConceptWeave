...
- For an ontology-library candidate, record upstream revision and both licence sources, then keep it behind a ConceptWeave port/ACL until an RDF/OWL/SKOS/SHACL fixture and protected release prove the supported subset. A repository survey does not justify a dependency or shared utility repository.
