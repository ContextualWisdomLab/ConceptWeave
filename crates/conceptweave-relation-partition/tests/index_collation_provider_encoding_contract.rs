...
fn identity_in(schema: &str, name: &str, encoding: i32) -> CollationCatalogIdentity {
...
#[test]
fn builtin_catalog_encoding_is_derived_from_the_builtin_locale_or_copied_source() {
    builtin("C", -1).expect("direct PostgreSQL 18 built-in C is encoding-independent");
    builtin("C", 6).expect(
...
#[test]
fn postgresql18_ucs_basic_and_its_copies_are_utf8_builtin_c() {
    CollationDefinitionObservation::new(
    ...
    CollationDefinitionObservation::new(
        identity_in("public", "ucs_basic_copy", 6),
        PostgresCollationProvider::Builtin,
        true,
        None,
        None,
