include!("index_exclusion_constraint_operator_procedure_transform_converter_argument_modes_contract.rs");
...
fn ordinary_exclude_transform_converter_argument_names_preserve_null_named_and_empty_position_distinctly() {
    ...
    let unnamed = IndexExclusionConstraintOperatorProcedureTransformConverterArgumentNamesSnapshot::new(
        &predecessor,
    ...
    let named = IndexExclusionConstraintOperatorProcedureTransformConverterArgumentNamesSnapshot::new(
        &predecessor,
        named_observations,
    )
    .unwrap();
    assert_eq!(named.observations()[0].argument_names(), Some(&["value".to_owned()][..]));
    ...
    let mixed = IndexExclusionConstraintOperatorProcedureTransformConverterArgumentNamesSnapshot::new(
...
fn ordinary_exclude_transform_converter_argument_names_reject_vector_length_drift() {
    ...
    let error = IndexExclusionConstraintOperatorProcedureTransformConverterArgumentNamesSnapshot::new(
        &predecessor,
        too_many,
    )
...
fn ordinary_exclude_transform_converter_argument_names_reject_completeness_binding_and_duplicate_failures() {
    let predecessor = converter_argument_modes_snapshot();
    let missing = IndexExclusionConstraintOperatorProcedureTransformConverterArgumentNamesSnapshot::new(
        &predecessor,
    ...
    .expect_err("every argument-mode predecessor direction needs explicit proargnames evidence");
    assert_field(
        missing,
    ...
    let extra_error = IndexExclusionConstraintOperatorProcedureTransformConverterArgumentNamesSnapshot::new(
        &predecessor,
        extra,
    )
    ...
    let duplicate = IndexExclusionConstraintOperatorProcedureTransformConverterArgumentNamesSnapshot::new(
        &predecessor,
    ...
    let binding = IndexExclusionConstraintOperatorProcedureTransformConverterArgumentNamesSnapshot::new(
        &predecessor,
        drift,
    )
...
fn ordinary_exclude_transform_converter_argument_names_preserve_location_receipt_and_input_edges() {
    let predecessor = converter_argument_modes_snapshot();
    let snapshot = IndexExclusionConstraintOperatorProcedureTransformConverterArgumentNamesSnapshot::new(
        &predecessor,
        complete_converter_argument_names_observations(),
    )
    .unwrap();
    ...
    let schema_location = IndexExclusionConstraintOperatorProcedureTransformConverterArgumentNamesObservation::new(
        coordinate(),
        1,
        dotted_schema,
        IndexExclusionConstraintOperatorProcedureTransformConverterDirection::FromSql,
    ...
    .unwrap()
    .canonical_location();
    let type_location = IndexExclusionConstraintOperatorProcedureTransformConverterArgumentNamesObservation::new(
        coordinate(),
        1,
        dotted_type,
        IndexExclusionConstraintOperatorProcedureTransformConverterDirection::FromSql,
    ...
    for (schema, function, field) in [
        (" ", "payload_from_sql", "index_exclusion_constraint_operator_procedure_transform_converter_argument_names_function_schema"),
        ("public", "\t", "index_exclusion_constraint_operator_procedure_transform_converter_argument_names_function_name"),
    ] {
        let error = IndexExclusionConstraintOperatorProcedureTransformConverterArgumentNamesObservation::new(
            coordinate(),
            1,
    ...
    let zero = IndexExclusionConstraintOperatorProcedureTransformConverterArgumentNamesObservation::new(
        coordinate(),
        0,
        custom_payload_type(),
        IndexExclusionConstraintOperatorProcedureTransformConverterDirection::FromSql,
