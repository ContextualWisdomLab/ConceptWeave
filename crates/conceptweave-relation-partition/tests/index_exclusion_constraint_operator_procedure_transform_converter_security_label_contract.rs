include!("index_exclusion_constraint_operator_procedure_transform_converter_auto_extension_dependency_contract.rs");
...
fn ordinary_exclude_converter_security_labels_distinguish_unlabeled_and_mac_labeled_functions() {
    ...
    let unlabeled = IndexExclusionConstraintOperatorProcedureTransformConverterSecurityLabelSnapshot::new(
        &predecessor,
    ...
    assert_eq!(labeled.observations()[0].security_labels()[0].provider(), "selinux");
    assert_eq!(
...
fn ordinary_exclude_converter_security_labels_preserve_provider_order_independently_and_raw_label_text() {
    let predecessor = converter_auto_extension_dependency_snapshot();
    let left = IndexExclusionConstraintOperatorProcedureTransformConverterSecurityLabelSnapshot::new(
        &predecessor,
        vec![
            converter_security_label_observation(
                IndexExclusionConstraintOperatorProcedureTransformConverterDirection::FromSql,
    ...
    .unwrap();
    let right = IndexExclusionConstraintOperatorProcedureTransformConverterSecurityLabelSnapshot::new(
        &predecessor,
        vec![
            converter_security_label_observation(
                IndexExclusionConstraintOperatorProcedureTransformConverterDirection::FromSql,
    ...
    assert_eq!(left.observations()[0].security_labels()[0].provider(), "a_provider");
    assert_eq!(left.observations()[0].security_labels()[0].label(), " raw label \t");
    assert_eq!(left.observations()[0].security_labels()[1].provider(), "z_provider");
...
fn ordinary_exclude_converter_security_labels_reject_completeness_binding_and_duplicate_coordinates() {
    let predecessor = converter_auto_extension_dependency_snapshot();
    let missing = IndexExclusionConstraintOperatorProcedureTransformConverterSecurityLabelSnapshot::new(
        &predecessor,
    ...
    let binding = IndexExclusionConstraintOperatorProcedureTransformConverterSecurityLabelSnapshot::new(
        &predecessor,
        drift,
    )
...
fn ordinary_exclude_converter_security_labels_preserve_root_location_and_exact_receipt() {
    let predecessor = converter_auto_extension_dependency_snapshot();
    let snapshot = IndexExclusionConstraintOperatorProcedureTransformConverterSecurityLabelSnapshot::new(
        &predecessor,
        complete_converter_security_label_observations(),
    )
    .unwrap();
    ...
    let left = IndexExclusionConstraintOperatorProcedureTransformConverterSecurityLabelObservation::new(
        coordinate(),
        1,
    ...
    .unwrap()
    .canonical_location();
    let right = IndexExclusionConstraintOperatorProcedureTransformConverterSecurityLabelObservation::new(
        coordinate(),
        1,
        QualifiedTypeName::new("payload", "domain.json").unwrap(),
        IndexExclusionConstraintOperatorProcedureTransformConverterDirection::FromSql,
