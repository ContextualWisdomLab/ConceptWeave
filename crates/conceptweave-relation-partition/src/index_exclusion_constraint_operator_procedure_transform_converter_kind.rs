...
impl IndexExclusionConstraintOperatorProcedureTransformConverterKindSnapshot {
    ...
    pub fn new(
        ...
        Ok(Self {
            ...
            snapshot_digest,
            converter_snapshot_digest: cost_snapshot.converter_snapshot_digest().to_owned(),
...
fn compute_transform_converter_kind_digest(
    ...
    hasher.update(
        INDEX_EXCLUSION_CONSTRAINT_OPERATOR_PROCEDURE_TRANSFORM_CONVERTER_KIND_DIGEST_DOMAIN_V1,
    );
