...
- Initial retained-fixture updates: `b501b003fbcbfe612f92aa65d83a7fd82cedb68a` and `8b36c7a67f8a90b24ad2f08c02ead23374dc4c94`.
- Static repair review `5184320142` then caught that those integration fixtures and the new RED called private `with_observed_constraint_timings()`. The invariant was not weakened or the method exposed merely for tests.
- Public-contract fixture corrections: `90d4ba255ebcc56f4f6eed76b4e6d0d4be5ced15`, `f402b0e39d3a7125476f471edac79fa776e347f2`, and `95074fdff8f3e66c4ed4e54215bd4f59f2cf3e86` move integration tests to `new_with_constraint_timings(...)`.
