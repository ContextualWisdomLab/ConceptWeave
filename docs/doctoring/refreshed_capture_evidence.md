...
The manual aggregation is now replaced by the capture-bound API and `--full-text-availability REPORT CAPTURE SUMMARY` command at `3ca46b17c909a2785c04f9de344ead156ef0ee82`. The optimized full-data invocation exited 0 and produced a 359-byte mode-0600 aggregate with file SHA-256 `caaed74869c03779750649fc768034a0d4b12566e9cadfbe77b3bd8eca7d2ac8`. It reverified capture digest `sha256:86f9c13043a504c9a6ad8f7ecb6dc6bcf207e9e98f19c5573dd39980844d87c1` and returned 3,715 papers, 3,203 with nonempty text, queues 440/34/38, 471 missing-text papers with classifier abstention, and two unbound nonempty records. The output contains no item keys, titles or text. Unit tests cover partitioning, deduplication, nested/orphan/cyclic ancestry, unbound records and tamper rejection; independent static re-review returned PASS. This capability measures availability only and grants no review, approval or Zotero write authority.

Coverage-path completion at `666cd6ba25100b3382cbcb977f112c6e8d42620c` reuses the same validated content decoder instead of retaining an unreachable duplicate error path. The current unchanged coverage gate passes 442/442 functions, 4,656/4,656 source-normalized regions and 754/754 branch outcomes. The full release workspace suite also exited 0.
