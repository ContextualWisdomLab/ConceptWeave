...
- #46 `codex/pr6-v3-index-evidence`, OPEN Draft/mergeable, is the active Source Observation writer. Its current lineage has advanced ordinary-forward beyond the prior RED head through column-collation production repair and edge-contract hardening.
...
Current Source Observation state is **SOURCE_REPAIRED / ACCEPTANCE_PENDING**. The repair has not yet earned native/Product GREEN, Ready, merge authorization, publication, or release status.
...
| --- | --- | --- |
| Source Observation | SOURCE_REPAIRED / ACCEPTANCE_PENDING | `5187855669 -> 8006b24f... -> 313f27c... -> 3e495eac... -> 66489478... -> 3d8a7fb7... -> 8a4b7a1b... -> 6fb0c2b6...`; execute exact-head acceptance. |
...
| Quality gate | BLOCKED_ON_EXACT_HEAD_EXECUTION | Source repair exists; generate Rust 1.98/native and hosted acceptance on one unchanged head. |
...
1. Keep the repaired column-collation source and all retained index/lifecycle/temporal invariants intact; do not weaken them to manufacture acceptance.
2. Run the collation contract plus retained contracts, then reacquire one unchanged exact-head Rust 1.98 and hosted Product/security/dependency/review acceptance. Head movement restarts the acceptance set.
