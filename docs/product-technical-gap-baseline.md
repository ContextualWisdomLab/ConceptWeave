...
| Product CI | CENTRAL_REVIEW_REPAIR_PENDING | #35 unchanged; #2106 core hosted gates are GREEN but Noema/Strix failures and independent approval remain. #2115 is retired by verified successor; #2114 has advanced to `87510bbb...`, is Draft again, and must finish its fresh current-head hosted runs plus independent review before integration/replay. |
