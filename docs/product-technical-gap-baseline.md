...
This refresh follows procedural self-application source/test head `abb8d7f98973d6ba77799b9bbc69d82353f48454`. RED-only test head `c476ce244a6e6774a8b1d12c7b38613deaada2db` first required the local-Git provenance receipt to stop claiming generic `source_authentication_established`; the minimal source repair renamed that output to the narrower `local_git_provenance_established`. The commit containing this file is a documentation-only successor, so source-head local evidence does not automatically become exact-current whole-head evidence.
...
- Procedural self-application #44: source/test head `abb8d7f98973d6ba77799b9bbc69d82353f48454`, OPEN Draft on #43. It adds inferred self-application profiles, a Rust topology/evidence-membership candidate, local-Git source-provenance verification, strict duplicate-key checked-in artifact admission, regular-file path-mode binding for provenance sources, bounded non-echoing duplicate-key diagnostics, and a provenance receipt that no longer overclaims source authentication.
...
Six artifact-admission defects now have explicit RED -> repair evidence on #44:
...
4. Restack dependent #5/#9/#43 and descendants normally and reset evidence. #44 retains the six artifact-admission RED/repair lineages.
