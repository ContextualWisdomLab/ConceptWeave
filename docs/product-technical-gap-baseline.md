...
- #46 `codex/pr6-v3-index-evidence`, OPEN Draft, is the active Source Observation writer. The current lineage contains PostgreSQL 18 first-class NOT NULL evidence, signed-`int2` `coninhcount`, corrected PRIMARY KEY completeness, enforced-only NOT NULL state, fail-closed table-like relation ownership, relation-wide `pg_constraint` name integrity across the standard and NOT NULL evidence families, partition `NO INHERIT` rejection, parent-row/column resolution, parent-graph acyclicity, direct declarative-partition parent validation against an independently captured `pg_inherits` witness, fail-closed `inhdetachpending` handling, PostgreSQL-compatible parent/child `convalidated` asymmetry, and fail-closed inheritance-origin coherence for `conislocal=false / coninhcount=0`. Review `5195981967` isolates the cross-family constraint-name gap; executable RED `79d91622a403a29028e463ba3d7e8adc88f988ad`, production repair `aaf4b3144452a67d938fd12a78b4e6fee6c44b6b`, fixture isolation `0cff8f0a23fc65a66ee5ce9499ea99d9bb101bce`, and doctoring `ffad14c0825c6663b026f6a28adc814d9ddd0ff7` preserve the current causal lineage. Exact-head native and hosted acceptance remain pending.
