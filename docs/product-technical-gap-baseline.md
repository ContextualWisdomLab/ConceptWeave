...
- #46 `codex/pr6-v3-index-evidence`, OPEN Draft, is the active Source Observation writer. The current lineage contains PostgreSQL 18 first-class NOT NULL evidence, signed-`int2` `coninhcount`, corrected PRIMARY KEY completeness, enforced-only NOT NULL state, partition `NO INHERIT` rejection, parent-row/column resolution, parent-graph acyclicity, direct declarative-partition parent validation against an independently captured `pg_inherits` witness, fail-closed `inhdetachpending` handling, and PostgreSQL-compatible parent/child `convalidated` asymmetry. Direct-parent review `5194258395` is followed by RED `51a8f2680943f2526b1f03712ebf92f5cad30c10`, production `4cbb426d045f290a061820593fee0a870c7cbd94`, retained-contract alignment `d7c11072ab1c03d928129b547be9b0d608fc8039`, and edge coverage `610a557526f85f456bdd8c8c1e28fe184b3a79f0`. Follow-up review `5194302440` identified discarded detach state; source repair `ee12c67716de0c617f40f9f75bda3ae2528b639f`, retained fixture updates `e4d33a9dceecea57c88dfd0a5b848be2f05921de` / `4359936e2a32566428b8eaafdeee97386152d509`, detach regression `eaa354bb6d0d0eee72753bf868bb8881ba5e6a0b`, and doctoring `5f55729965dd8e2317289a3eea0d4cd180ceb425` preserve that causal lineage. Review `5194758807` then isolated inherited validation compatibility; executable regression `6cdadfa9e261f1a99f4e2afd96c9a52e7b455d17`, production repair `503e88bb6a5813913da7eb502791a68c9c56c04e`, and doctoring `1e0514e32173ce8ca372eb4271fac4345c554099` preserve PostgreSQL's asymmetric rule without globally rejecting `NOT VALID`. Exact-head native and hosted acceptance remain pending.
