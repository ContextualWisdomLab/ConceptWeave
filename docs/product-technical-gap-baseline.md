...
- `docs/doctoring/zotero_source_resolution_item_identity.md` records the earlier report-binding lane. `docs/doctoring/zotero_source_resolution_unknown_fields.md` records the strict-wire RED → causal repair and keeps the lane at `SOURCE_TEST_REPAIRED_PENDING_CI` until exact-head Rust/coverage/hosted/independent-review evidence exists.
