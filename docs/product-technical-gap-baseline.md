...
| Product CI | CENTRAL_SETTLEMENT_PENDING | #35 unchanged; central `.github#2114@3c43dd16...` has Runtime Quality/Security/Python/Semgrep GREEN and CodeQL settlement failure. Central handler settlement and independent review remain outside this leaf. |
