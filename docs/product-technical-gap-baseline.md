...
- #46 `codex/pr6-v3-index-evidence`, OPEN Draft, is the active Source Observation writer. The current lineage contains PostgreSQL 18 first-class NOT NULL evidence, signed-`int2` `coninhcount`, corrected PRIMARY KEY completeness, enforced-only NOT NULL state, fail-closed table-like relation ownership, relation-wide `pg_constraint` name integrity across the standard and NOT NULL evidence families, partition `NO INHERIT` rejection, parent-row/column resolution, parent-graph acyclicity, direct declarative-partition parent validation against an independently captured `pg_inherits` witness, fail-closed `inhdetachpending` handling, PostgreSQL-compatible parent/child `convalidated` asymmetry, and fail-closed inheritance-origin coherence for `conislocal=false / coninhcount=0`. Review `5195981967` isolates the cross-family constraint-name gap; executable RED `79d91622a403a29028e463ba3d7e8adc88f988ad`, production repair `aaf4b3144452a67d938fd12a78b4e6fee6c44b6b`, and doctoring `783c544dcd82d428c36a3a25fc7426a9216cab85` preserve the current causal lineage. Exact-head native and hosted acceptance remain pending.
...
- relation-wide constraint-name integrity: `5195981967 -> 79d91622... -> aaf4b314... -> 783c544d...`.
...
- `.github#2170@d493cc4c53d0b77d67ef4af13005dcda8fb33c7f` remains OPEN Ready / mechanically mergeable and one protected commit behind. Review `5195808542` records the path-disjoint ordinary/non-force restack prerequisite. Its predecessor acceptance evidence becomes historical on head movement.
- `.github#2079@2d27e0c13f9b118ca844f5299b0fcdde420fa66b` remains OPEN Ready / mechanically mergeable and one protected commit behind. Review `5195811048` records the same prerequisite. Its predecessor acceptance evidence likewise cannot transfer after restack.
...
No ConceptWeave leaf copies or edits these central owner sources. #2106 now proceeds through its owner-local traceability repair and fresh exact-head gates; #2170/#2079 must preserve `91be6442...` by ordinary/non-force integration and obtain their own fresh acceptance. Only after central owners settle and #35 lands normally can one unchanged #46 head obtain meaningful hosted Product acceptance. The complete #46 delta then flows ordinary/non-force into #45, followed by fresh #45 acceptance and #6 propagation.
