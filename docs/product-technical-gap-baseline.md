...
- Pending-source resolution #40: source repair `2760ebd` follows strict-wire RED `a7b2588baa727ce973323c900e1d00b9c76425b2` and adds deny-unknown-fields admission to the persisted wire and nested decision/identity DTOs. The live PR ref is authoritative for later docs-only successors. Earlier reality RED `a3cd9b0d68b4ecc28322860d04a23867412d611f` proved internal duplicated identity was not an external immutable-report binding, and causal repair `453878f236cd46ae5389575719f37077302da70e` replaced direct trusted deserialization with report-bound restoration. Status is `SOURCE_TEST_REPAIRED_PENDING_CI`, not executable GREEN: focused tests and Clippy pass locally, while owned coverage, hosted checks and independent review remain outstanding. #40 owns only the typed read-only exact-snapshot resolution aggregate; it has no Zotero write, semantic publication or approval authority.
...
| Pending-source resolution | SOURCE_TEST_REPAIRED_PENDING_CI | #40's report-bound restoration rejects missing provider identity, nested server/library drift, duplicate/unsorted/blank stored decisions, blank stored rule revision, missing decisions, item-identity drift and undeclared fields. Source repair is locally GREEN; exact-head owned coverage, hosted checks and independent-review evidence are still required. |
