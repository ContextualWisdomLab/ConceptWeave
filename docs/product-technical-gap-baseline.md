...
## September 8 research lifecycle and abstention checkpoint
...
5. Zotero Research Classification PR #9 — current source-repair head `67d0d5e55ed77bfcc65ae83a986a0d7dc690dc61` preserves lifecycle repair `72bf15a...` and adds the bounded non-ASCII abstention repair after RED `cd791f9...`. This baseline update creates the next docs-only successor; executable evidence never transfers across that head movement.
