...
- Rust-first `conceptweave-observation` contract for immutable PostgreSQL schema snapshots with exact qualified identifiers, deterministic source ordering, snapshot/extractor/time evidence, and fail-closed duplicate or blank metadata validation.
